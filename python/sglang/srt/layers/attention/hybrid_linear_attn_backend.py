...
class MambaAttnBackendBase(AttentionBackend):
    ...
    def _forward_metadata(self, forward_batch: ForwardBatch):
        ...
        if mamba_cache_src_indices is None:
            ...
            if _real_bs is not None and _real_bs < mamba_cache_src_indices.shape[0]:
    ...
    def _replay_metadata(
        ...
        self.state_src_indices_list[bs - 1][: len(mamba_cache_src_indices)].copy_(
            mamba_cache_src_indices
        )
        self.state_dst_indices_list[bs - 1][: len(mamba_cache_dst_indices)].copy_(
        ...
        if forward_batch.mamba_track_mask is not None:
            ...
            if self.forward_metadata.num_decodes > 0:
                ...
                track_mamba_states_if_needed(
                    layer_cache.conv[0],
                    layer_cache.temporal,
                    self.forward_metadata.mamba_cache_dst_indices[-num_decodes:],
