...
class SchedulerBatchResultProcessor:
    ...
    decoupled_commit_draft_mamba_ckpts: Callable
    decoupled_flush_draft_updates: Callable

    def _flush_decoupled_draft_outputs(
        self,
        batch: ScheduleBatch,
    ...
    def process_batch_result_prefill(
        ...
        self._flush_decoupled_draft_outputs(batch)
