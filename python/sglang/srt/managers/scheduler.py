...
class Scheduler(
    ...
    def __init__(
        ...
        if self.spec_algorithm.is_decoupled_draft() and self.enable_overlap:
        ...
        if self.spec_algorithm.is_decoupled_verify():
            ...
            self.start_verify_proxy(self.ipc_channels.context)
    ...
    def init_batch_result_processor(self) -> None:
        self.batch_result_processor = SchedulerBatchResultProcessor(
            ...
            decoupled_commit_draft_mamba_ckpts=self.commit_draft_mamba_ckpts,
            decoupled_flush_draft_updates=self.flush_draft_updates,
        )
